...
public:
    ...
    Array1<T>(const Array1<T> &that) = delete;
    Array1<T>& operator=(const Array1<T> &that) = delete;
...
public:
    ...
    Array2<T>(const Array2<T> &that) = delete;
    Array2<T>& operator=(const Array2<T> &that) = delete;
    ...
    void getDims(T dims[2]) const
    {
        dims[0] = c_n1; dims[1] = c_n2;
    }
...
public:
    ...
    Array3<T>(const Array3<T> &that) = delete;
    Array3<T>& operator=(const Array3<T> &that) = delete;
    ...
    void getDims(T dims[3]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3;
    }
...
public:
    ...
    Array4<T>(const Array4<T> &that) = delete;
    Array4<T>& operator=(const Array4<T> &that) = delete;
    ...
    void getDims(T dims[4]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4;
    }
...
public:
    ...
    Array5<T>(const Array5<T> &that) = delete;
    Array5<T>& operator=(const Array5<T> &that) = delete;
    ...
    void getDims(T dims[5]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4; dims[4] = c_n5;
    }
...
public:
    ...
    Array6<T>(const Array6<T> &that) = delete;
    Array6<T>& operator=(const Array6<T> &that) = delete;
    ...
    void getDims(T dims[6]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4; dims[4] = c_n5; dims[5] = c_n6;
    }
...
public:
    ...
    Array7<T>(const Array7<T> &that) = delete;
    Array7<T>& operator=(const Array7<T> &that) = delete;
    ...
    void getDims(T dims[7]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4; dims[4] = c_n5; dims[5] = c_n6; dims[6] = c_n7;
    }
...
public:
    ...
    Array8<T>(const Array8<T> &that) = delete;
    Array8<T>& operator=(const Array8<T> &that) = delete;
    ...
    void getDims(T dims[8]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4; dims[4] = c_n5; dims[5] = c_n6; dims[6] = c_n7; dims[7] = c_n8;
    }
...
public:
    ...
    Array9<T>(const Array9<T> &that) = delete;
    Array9<T>& operator=(const Array9<T> &that) = delete;
    ...
    void getDims(T dims[9]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4; dims[4] = c_n5; dims[5] = c_n6; dims[6] = c_n7; dims[7] = c_n8; dims[8] = c_n9;
    }
...
public:
    ...
    Array10<T>(const Array10<T> &that) = delete;
    Array10<T>& operator=(const Array10<T> &that) = delete;
    ...
    void getDims(T dims[10]) const
    {
        dims[0] = c_n1; dims[1] = c_n2; dims[2] = c_n3; dims[3] = c_n4; dims[4] = c_n5; dims[5] = c_n6; dims[6] = c_n7; dims[7] = c_n8; dims[8] = c_n9; dims[9] = c_n10;
    }
